...
do_patch() {
    ...
    PATCH_DOCKERFILE_INTELVSP="${PATCH_DOCKERFILE_INTELVSP:-https://file.corp.redhat.com/~thaller/dpu-operator/patch-dockerfile-IntelVSP.sh}"
