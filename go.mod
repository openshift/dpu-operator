...
require (
	...
	//github.com/intel/ipu-opi-plugins/ipu-plugin v0.0.0-20250122021424-ed46732aeeba
	github.com/intel/ipu-opi-plugins/ipu-plugin v0.0.0-20250127213651-eab00d624065
