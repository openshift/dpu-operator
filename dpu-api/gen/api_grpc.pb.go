...
const (
	DpuNetworkConfigService_SetDpuNetworkConfig_FullMethodName = "/Vendor.DpuNetworkConfigService/SetDpuNetworkConfig"
)
...
func (c *dpuNetworkConfigServiceClient) SetDpuNetworkConfig(ctx context.Context, in *DpuNetworkConfigRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, DpuNetworkConfigService_SetDpuNetworkConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDpuNetworkConfigServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedDpuNetworkConfigServiceServer) SetDpuNetworkConfig(context.Context, *DpuNetworkConfigRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetDpuNetworkConfig not implemented")
}
func (UnimplementedDpuNetworkConfigServiceServer) mustEmbedUnimplementedDpuNetworkConfigServiceServer() {
}
func (UnimplementedDpuNetworkConfigServiceServer) testEmbeddedByValue() {}
...
func RegisterDpuNetworkConfigServiceServer(s grpc.ServiceRegistrar, srv DpuNetworkConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedDpuNetworkConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var DpuNetworkConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Vendor.DpuNetworkConfigService",
