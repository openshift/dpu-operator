...
func NewDpuOperatorConfigReconciler(client client.Client, scheme *runtime.Scheme, dpuDaemonImage string, vspImages map[string]string, webhookImage string) *DpuOperatorConfigReconciler {
