...
func (UnimplementedNetworkFunctionServiceServer) CreateNetworkFunction(context.Context, *NFRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateNetworkFunction not implemented")
}
func (UnimplementedNetworkFunctionServiceServer) DeleteNetworkFunction(context.Context, *NFRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteNetworkFunction not implemented")
}
...
func RegisterNetworkFunctionServiceServer(s grpc.ServiceRegistrar, srv NetworkFunctionServiceServer) {
	// If the following call panics, it indicates UnimplementedNetworkFunctionServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type t interface {
	DpuRebootFunction(ctx context.Context, in *DPUManagementRequest, opts ...grpc.CallOption) (*DPUManagementResponse, error)
	DpuFirmwareUpgradeFunction(ctx context.Context, in *DPUManagementRequest, opts ...grpc.CallOption) (*DPUManagementResponse, error)
}
...
func (c *dataProcessingUnitManagementServiceClient) DpuRebootFunction(ctx context.Context, in *DPUManagementRequest, opts ...grpc.CallOption) (*DPUManagementResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *dataProcessingUnitManagementServiceClient) DpuFirmwareUpgradeFunction(ctx context.Context, in *DPUManagementRequest, opts ...grpc.CallOption) (*DPUManagementResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DPUManagementResponse)
...
type DataProcessingUnitManagementServiceServer interface {
	DpuRebootFunction(context.Context, *DPUManagementRequest) (*DPUManagementResponse, error)
	DpuFirmwareUpgradeFunction(context.Context, *DPUManagementRequest) (*DPUManagementResponse, error)
...
func (UnimplementedDataProcessingUnitManagementServiceServer) DpuRebootFunction(context.Context, *DPUManagementRequest) (*DPUManagementResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DpuRebootFunction not implemented")
}
func (UnimplementedDataProcessingUnitManagementServiceServer) DpuFirmwareUpgradeFunction(context.Context, *DPUManagementRequest) (*DPUManagementResponse, error) {
...
func _DataProcessingUnitManagementService_DpuRebootFunction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataProcessingUnitManagementServiceServer).DpuRebootFunction(ctx, req.(*DPUManagementRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DataProcessingUnitManagementService_DpuFirmwareUpgradeFunction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataProcessingUnitManagementServiceServer).DpuFirmwareUpgradeFunction(ctx, req.(*DPUManagementRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (UnimplementedDeviceServiceServer) SetNumVfs(context.Context, *VfCount) (*VfCount, error) {
	return nil, status.Error(codes.Unimplemented, "method SetNumVfs not implemented")
}
