...
func DpuUpgradeFirmwareFunction(ctx context.Context, client sgpb.SoftwareManagementServiceClient, filePath string) (*sgpb.SoftwareUpgradeResponse, error) {
