...
func (debugDP *DebugDP) AddFlowRuleToDataPlane(bridgeName string, inpPort []string, outPort string) error {
	debugDP.log.Info("AddNfRuleToDataPlane", "bridgeName", bridgeName, "inpPort", inpPort, "outPort", outPort)
	return nil
}
func (debugDP *DebugDP) DeleteFlowRuleFromDataPlane(bridgeName string, inPort []string, outPort string) error {
	debugDP.log.Info("DeleteNfRuleFromDataPlane", "bridgeName", bridgeName, "inPort", inPort, "outPort", outPort)
	return nil
}
